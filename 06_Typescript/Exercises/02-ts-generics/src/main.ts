...
// mergeObjects({ name: "Guybrush", age: 123354 }); // ERROR!
//
...
//
const pluck = <T extends object, K extends keyof T>(obj: T, key: K): T[K] =>
  obj[key];
...
const user2 = { userName: "Guybrush", asdf: 42 };
// UserKey = "userName" | "asdf";

const age2 = pluck(user2, "userName"); // 36
