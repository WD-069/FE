...
import type { EventsRespone, Event } from '@/types';

const Events = () => {
  const [allEvents, setAllEvents] = useState<Event[]>([]);
  const [currentPage, setCurrentPage] = useState<EventsRespone['currentPage']>(1);
  const [hasNextPage, setHasNextPage] = useState<EventsRespone['hasNextPage']>();
